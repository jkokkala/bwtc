...
#ifndef BWTC_HUFFMANRL_UTIL_HPP_
#define BWTC_HUFFMANRL_UTIL_HPP_
...
class HuffmanRLUtilEncoder {
 public:
  HuffmanRLUtilEncoder();
  ~HuffmanRLUtilEncoder();
...
void finishBlock(OutStream* out);
 ...
 private:
  ...
  HuffmanRLUtilEncoder(const HuffmanRLUtilEncoder&);
  HuffmanRLUtilEncoder& operator=(const HuffmanRLUtilEncoder&);
};

class HuffmanRLUtilDecoder {
 public:
  HuffmanRLUtilDecoder();
  ~HuffmanRLUtilDecoder();
 ...
 private:
  ...
  HuffmanRLUtilDecoder(const HuffmanRLUtilDecoder&);
  HuffmanRLUtilDecoder& operator=(const HuffmanRLUtilDecoder&);
};
